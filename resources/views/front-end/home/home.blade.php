        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-product">
                        <div class="product-img">
                            <img class="img-fluid w-100" src="{{asset($inspiredProduct->main_image)}}" alt="" />
                            <div class="p_icon">
                                <a href="#">
                                    <i class="ti-eye"></i>
                                </a>
                        ...
                        <div class="product-btm">
                            <a href="#" class="d-block">
                                <h4>{{$inspiredProduct->product_name}}</h4>
                            </a>
                            <div class="mt-3">
                                <span class="mr-4">TK.{{$inspiredProduct->product_price}}</span>
                                <del>$35.00</del>
                            </div>
                        </div>
                    </div>
